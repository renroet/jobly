...
const { createFilteredSearch, createCompanySearch } = require("../helpers/filters")
...
router.get("/", async function (req, res, next) {
  try {
    ...
    let search = keys.map((el) => el.toLowerCase())
      ...
      let sqlTerms = createCompanySearch(searchTerms)
      console.log(sqlTerms)
      const companies = await Company.findFilteredSearch(sqlTerms);
